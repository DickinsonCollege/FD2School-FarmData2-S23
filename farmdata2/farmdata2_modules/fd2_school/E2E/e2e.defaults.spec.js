describe("Test the harvest report default values", () => {
    ...
    it("Check the crop dropdown", () => {
        cy.get("[data-cy = crop-dropdown]").children().eq(0).should("eq" , "ARUGULA")
        cy.get("[data-cy = crop-dropdown]").children().eq(4).should("eq" , "BEAN-FAVA")
        cy.get("[data-cy = crop-dropdown]").children().eq(110).should("eq" , "ZUCCHINI")
